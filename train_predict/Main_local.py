...
def main():
    ...
    net, loss_list, grad_list, hidden_rep, output_rep = train_partial(y_mini, h0, epochs, lr, learning_alg, print_freq)
...
def train_partial(Y_mini, h0, n_epochs, lr, learning_alg, print_freq=1000):
    '''
